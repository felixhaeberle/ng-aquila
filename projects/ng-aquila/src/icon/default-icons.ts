...
export const DEFAULT_ICONS: { [k: string]: string } = {
  ...
  'info-circle': '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><defs><style>.cls-1{fill:none}</style></defs><path id="inner-path" class="cls-1" d="M16 8a1.5 1.5.0 1 1-1.5 1.5A1.5 1.5.0 0 1 16 8zm4 13.875H17.125v-8H13v2.25h1.875v5.75H12v2.25h8z" transform="translate(0 0)"/><path d="M16 2A14 14 0 1 0 30 16 14 14 0 0 0 16 2zm0 6a1.5 1.5.0 1 1-1.5 1.5A1.5 1.5.0 0 1 16 8zm4 16.125H12v-2.25h2.875v-5.75H13v-2.25h4.125v8H20z" transform="translate(0 0)"/><path id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" class="cls-1" d="M0 0h32v32H0z"/></svg>',
    // discuss new arrows 
  'arrow-first': '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon" viewBox="0 0 32 32" style="enable-background:new 0 0 32 32"><style>.st0{fill:none}</style><path d="M14 16 24 6 25.4 7.4 16.8 16 25.4 24.6 24 26z"/><path d="M8 4h2v24H8z"/><path id="_Transparent_Rectangle_" class="st0" d="M0 0h32v32H0z"/></svg>',
  'arrow-left': '<svg xmlns="http://www.w3.org/2000/svg" id="icon" width="32" height="32" viewBox="0 0 32 32"><defs><style>.cls-1{fill:none}</style></defs><path d="M14 26 15.41 24.59 7.83 17H28V15H7.83l7.58-7.59L14 6 4 16 14 26z"/><path id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" class="cls-1" d="M0 0h32v32H0z"/></svg>',
  'arrow-right': '<svg xmlns="http://www.w3.org/2000/svg" id="icon" width="32" height="32" viewBox="0 0 32 32"><defs><style>.cls-1{fill:none}</style></defs><path d="M18 6 16.57 7.393 24.15 15H4v2H24.15L16.57 24.573 18 26 28 16 18 6z"/><path id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" class="cls-1" d="M0 0h32v32H0z"/></svg>',
  'arrow-last': '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon" viewBox="0 0 32 32" style="enable-background:new 0 0 32 32"><style>.st0{fill:none}</style><path d="M18 16 8 26 6.6 24.6 15.2 16 6.6 7.4 8 6z"/><path d="M22 4h2v24H22z"/><path id="_x3C_Transparent_Rectangle_x3E_" class="st0" d="M0 0h32v32H0z"/></svg>',
  ...
  'check': '<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" width="32" height="32" viewBox="0 0 32 32"><defs><style>.cls-1{fill:none}</style></defs><path d="M13 24 4 15 5.414 13.586 13 21.171 26.586 7.586 28 9 13 24z"/><path id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" class="cls-1" d="M0 0h32v32H0z"/></svg>',
  'ellipsis-h': '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon" width="32" height="32" viewBox="0 0 32 32" style="enable-background:new 0 0 32 32"><style>.st0{fill:none}</style><title>overflow-menu--horizontal</title><circle cx="8" cy="16" r="2"/><circle cx="16" cy="16" r="2"/><circle cx="24" cy="16" r="2"/><path id="_Transparent_Rectangle_" class="st0" d="M0 0h32v32H0z"/></svg>',
  'ellipsis-v': '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon" width="32" height="32" viewBox="0 0 32 32" style="enable-background:new 0 0 32 32"><style>.st0{fill:none}</style><title>overflow-menu--vertical</title><circle cx="16" cy="8" r="2"/><circle cx="16" cy="16" r="2"/><circle cx="16" cy="24" r="2"/><path id="_Transparent_Rectangle_" class="st0" d="M0 0h32v32H0z"/></svg>',
